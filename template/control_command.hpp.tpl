#ifndef %(package_prefix)s_%(car_type)s_driver__CONTROL_COMMAND_HPP_
#define %(package_prefix)s_%(car_type)s_driver__CONTROL_COMMAND_HPP_
...
#endif // %(package_prefix)s_%(car_type)s_driver__CONTROL_COMMAND_HPP_